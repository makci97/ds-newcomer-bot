...
Чтобы завершить диалог и вернуться в меню для выбора другой задачи, используйте команду `/finish_dialog`.
...
1. Какие задания выполняет бот?
   ...
   - Вопросы на подумать:
      ...
      Бот придумает ряд вопросов на заданную пользователем тему указанного уровня сложности.
